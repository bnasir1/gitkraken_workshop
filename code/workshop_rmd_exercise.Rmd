...
## The graph shows that the MOV10_overexpression sample consistently had the highest normalized count from amongst the three samples while the control has the lowest count. 
```
...
## Heat map looks consistent with ggplot. The high MOV expression in MOV10_overexpression sample indicates significant results. 
```
